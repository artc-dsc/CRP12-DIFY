...
docker-compose up -d
```
After running, you can access the Dify dashboard in your browser at [https://localhost/install](https://localhost/install) and start the initialization process.
